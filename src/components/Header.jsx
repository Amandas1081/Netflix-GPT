  ...
  return (
    <div className='absolute px-2 py-2 z-1 w-screen bg-gradient-to-b from-black flex '>
      ...
      { user  && 
       ...
       {
        search===false ?
        <button onClick={handleGptSearchClick} className='absolute text-white right-50 mt-2 bg-blue-900 p-2  hover:cursor-pointer'>GPT Search</button>:
        <button onClick={handleGptSearchClick} className='absolute text-white right-50 mt-2 bg-blue-900 p-2  hover:cursor-pointer'>HomePage</button>
       }
       ...
       <button  onClick={handleClick} className='mt-3 mx-2 absolute right-5 text-white hover:cursor-pointer'>Sign out</button>
      </div> 
      }
